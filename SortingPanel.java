...
public class SortingPanel extends JPanel {
    ...
    public void animate() throws Exception{
        ...
        if (isInsertion) {
            ...
            Timer insertionTimer  = new Timer(100, new ActionListener(){
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        if (isSelection) {
            ...
            Timer selectionTimer  = new Timer(100, new ActionListener(){
                @Override
                public void actionPerformed(ActionEvent e) {
        ...
        if (isQuick) {
            ...
            Timer quickTimer  = new Timer(100, new ActionListener(){
                @Override
                public void actionPerformed(ActionEvent e) {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            g.drawRect(i*50, 600 - array[i], 49, array[i]);
            ...
            if (g.getColor() != Color.ORANGE && g.getColor() != Color.GREEN && g.getColor() != Color.BLUE && g.getColor() != Color.RED)
                g.setColor(Color.GRAY);

            g.fillRect(i*50, 600 - array[i], 49, array[i]);
        }
    }
}
